...
cliente(4, 'Maria', 'Gutierrez', 'Guatemala', E2, 'Soltero', 'Vacaciones', 1).
cliente(5, 'Cornelio', 'Bustamante', 'Guatemala', E2, 'Soltero', 'trabajo', 1).
cliente(6, 'Loraine', 'Cortez', 'Española', E2, 'Divorciado', 'Paso', 4).
cliente(7, 'Paco', 'Estanley', 'Guatemala', E2, 'Soltero', 'Vacaciones', 1).
cliente(8, 'Daniela', 'Samayoa', 'Guatemala', E2, 'Casado', 'trabajo', 1).
cliente(9, 'Silvia', 'Santis', 'El Salvador', E2, 'Casado', 'Paso', 1).
cliente(10, 'Luis', 'Ortega', 'El Salvador', E2, 'Soltero', 'Vacaciones', 1).
cliente(11, 'Tatiana', 'Lopez', 'El Salvador', E2, 'Soltero', 'Paso', 1).
cliente(12, 'Ronny', 'Paiz', 'Honduras', E2, 'Soltero', 'trabajo', 1).
cliente(13, 'Cesar', 'Ortiz', 'Guatemala', E2, 'Soltero', 'Paso', 1).
cliente(14, 'Margot', 'Claus', 'USA', E2, 'Soltero', 'Vacaciones', 1).
cliente(15, 'Jorge', 'Calderon', 'Venezuela', E2, 'Casado', 'Paso', 1).
cliente(17, 'Maira', 'Martinez', 'Mexico', E2, 'Soltero', 'trabajo', 1).
cliente(18, 'Jazmin', 'Dolores', 'Venezuela', E2, 'Casado', 'Vacaciones', 1).
cliente(19, 'Mauro', 'Hernandez', 'Español', E2, 'Soltero', 'Vacaciones', 4).
cliente(20, 'Luis', 'Sagastume', 'Costa Rica', E2, 'Soltero', 'trabajo', 1).
cliente(21, 'Rcharson', 'Patric', 'Inglaterra', E2, 'Casado', 'Vacaciones', 4).
cliente(22, 'Montheri', 'Lois', 'Inglaterra', E2, 'Casado', 'Vacaciones', 4).
cliente(23, 'Silverio', 'Perez', 'Mexico', E2, 'Casado', 'Paso', 1).
cliente(24, 'Monica', 'Suarez', 'Mexico', E2, 'Casado', 'trabajo', 1).
